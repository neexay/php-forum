...
<html lang="ru-RU">
    ...
    <body>
        <div class="page-wrapper">
            <!-- Подключение шапки -->
            <div class="grid">
                <?php if(isset($header)){echo $header;}else{ ?>
        ...
        <!-- Подключение Скриптов стандартных -->
        <?php require 'scripts.php'; ?>
        <!-- А ВОТ ТУТ можно подключить свой скрипт для определенной страницы-->
        <?php if(isset($sctipts)){echo $sctipts;}else{ ?>
            <!-- По умолчанию ничего нет-->
        <?php }?>
    </body>
</html>